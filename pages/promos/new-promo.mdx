...
1. `Products` - Hand pick products variants to include in the promotion, you can also pick one certain variants (Max 100 variants)
2. `Collections` - Apply a discount to a whole collection (Max 50 items)
